    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="multi_image[]"  class="form-control" type="file" value="{{ $aboutpage->about_image }}"  id="image" multiple="">
                </div>
            </div>
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}"  value="Add Multi Image">
                </div>
            </div>
            <!-- end row -->
